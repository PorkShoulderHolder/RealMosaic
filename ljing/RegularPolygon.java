...
public class RegularPolygon extends Shape {
	...
	/**
	 * Creates a default regular polygon (a hexagon, radius 10, unrotated, white
	 * background, black outline, no text).
	 */
	public RegularPolygon() {
		this(6, 10, 0, WHITE, BLACK, null);
	}
	 ...
	 */
	public RegularPolygon(int sides, int radius, double rotation, Color fill,
			Color outline, String text) {
		super(new Polygon(xCoordinates(sides, radius - 1, rotation),
				yCoordinates(sides, radius - 1, rotation), sides), fill,
				outline, text);
